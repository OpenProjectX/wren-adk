...
allprojects {
    group = "org.openprojectx.wren.adk"
}
                ...
                if (findByName("mavenJava") == null) {
                    create<MavenPublication>("mavenJava") {
                        ...
                        pom {
                            ...
                            description.set("WREN-ADK Spring Boot starter")
                            url.set("https://github.com/OpenProjectX/wren-adk")
                            ...
                            scm {
                                url.set("https://github.com/OpenProjectX/wren-adk")
                                connection.set("scm:git:https://github.com/OpenProjectX/wren-adk.git")
                                developerConnection.set("scm:git:ssh://git@github.com:OpenProjectX/wren-adk.git")
                            }
                        }
                    }
                }
